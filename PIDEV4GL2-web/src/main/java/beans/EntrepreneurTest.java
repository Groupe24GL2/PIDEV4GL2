...
public class EntrepreneurTest {
	...
	public void checkStatu() throws IOException{
		...
		if(res.equals("YES")){
			FacesContext.getCurrentInstance().getExternalContext().redirect("Entrepreneur.xhtml");
			//return "/xhtml/Entrepreneur?faces-redirect=true";
		}else {
			FacesContext.getCurrentInstance().getExternalContext().redirect("NonEntrepreneur.xhtml");
